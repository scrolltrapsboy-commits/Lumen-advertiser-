      ...
      screenDropdown = createLiquidDropdown({
        ...
        renderOption: (opt) => `
          <div style="display:flex;flex-direction:column;gap:2px;">
            <span style="font-weight:600;font-size:.875rem;">${escapeHTML(opt.value)} \u2014 ${escapeHTML(opt.meta.place)} <span class="badge badge-${opt.meta.status === 'online' ? 'online' : 'offline'}" style="margin-left:6px;font-size:0.65rem;vertical-align:middle;">${opt.meta.status === 'online' ? 'Online' : 'Offline'}</span></span>
