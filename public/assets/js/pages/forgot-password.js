...
(function init() {
  const tvMount = qs('#forgot-tv-mount');
  if (tvMount) {
    const tv = mountSmallDisplayTV(tvMount);
    tv.screenEl.innerHTML = '<div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;color:rgba(255,255,255,0.7);font-family:var(--font-display);font-size:14px;text-align:center;padding:12%;">Account recovery</div>';
  }
