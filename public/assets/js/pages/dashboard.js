...
(async function init() {
    ...
    <div class="dashboard-layout">
      ...
      <div class="mt-8">
        <div class="glass-card glass-card--floating">
          <div id="dashboard-tv-mount" class="small-display-tv-mount"></div>
  ...
  const dashboardTv = mountSmallDisplayTV(document.getElementById('dashboard-tv-mount'));
  mountNetworkPreview(dashboardTv.screenEl, {
